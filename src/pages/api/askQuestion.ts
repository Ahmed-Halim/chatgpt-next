...
export default async function handler(
  ...
  if (!prompt) {
    return res.status(400).json({ answer: 'Please Provider A Prompt' });
  }

  if (!chatId) {
    return res.status(400).json({ answer: 'Please Provider A Valid Chat ID' });
  }

  //const result = await chatgptQuery(prompt, parentMessageId);
  const result = {
    id: '1',
    text: 'ChatGPT was unable to find an answer to your question. Please try again later. ChatGPT was unable to find an answer to your question. Please try again later. ChatGPT was unable to find an answer to your question. Please try again later. ChatGPT was unable to find an answer to your question. Please try again later. ChatGPT was unable to find an answer to your question. Please try again later. ChatGPT was unable to find an answer to your question. Please try again later.'
  };
  ...
  return res.status(200).json({ answer: message.text, result });
}
